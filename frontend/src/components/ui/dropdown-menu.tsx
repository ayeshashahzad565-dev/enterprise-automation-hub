...
function DropdownMenuLabel({
  ...
  // `Menu.GroupLabel` requires a `MenuGroupContext` provider, only present
  // under `Menu.Group`/`Menu.RadioGroup` — this codebase uses
  // `DropdownMenuLabel` as a standalone section heading (the older
  // shadcn/Radix semantics, which didn't require a group), so it wraps
  // itself in a `Menu.Group` here rather than requiring every call site
